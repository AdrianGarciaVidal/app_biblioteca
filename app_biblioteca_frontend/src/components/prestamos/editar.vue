                ...
                <form action="">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href=""> <router-link to="/prestamos"> <i class="bi bi-arrow-return-left"></i>
...
const traer_objeto = (id) =>{
    axios.get(`http://127.0.0.1:8000/api/prestamos/store/${id}`)
        .then(response => {
            const api_prestamo = response.data.prestamo;
           libro_id.value = api_prestamo.libro_id;
           usuario_id.value = api_prestamo.usuario_id;
           fecha_prestamo.value = api_prestamo.fecha_prestamo;
           fecha_devolucion.value = api_prestamo.fecha_devolucion;
        })
        .catch(error => {
          alert('Error al enviar los datos:', error)
...
var fecha_prestamo = document.querySelector("#fecha_prestamo");
...
const guardar_datos = () => {
  ...
  icon: "error"
    ...
    axios.post('http://127.0.0.1:8000/api/prestamos/edit', datos)
        .then(response => {
